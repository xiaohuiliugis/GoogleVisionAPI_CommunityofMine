# -*- coding: utf-8 -*-
"""
Created on Tue Oct 27 23:16:25 2020
Reused code from last run
@author: liux29
"""
# before plot to visualize relationship of geometry, check there project, and project to WGS 84
#    data_shp = gpd.read_file(shapefile)
#    print (type(data_shp))
#    print (type(shapefile))
#    # Change projection to WGS 84
#    data_shp_proj = data_shp.copy()
#    data_shp_proj['geometry'] = data_shp_proj['geometry'].to_crs(epsg=4326)
#    
#    data_shp_proj.plot()
#
#    base = data_shp_proj.plot(color ='white', edgecolor='black')
...
input_img = r'C:\Users\liux29\OneDrive - National Institutes of Health\Research\Community_Mine\CoM_GIS_Data\GIS\Data_validation\test_img'
...
shapefile_dir = r'C:\Users\liux29\OneDrive - National Institutes of Health\Research\Community_Mine\CoM_GIS_Data\GIS\Data_validation\blkg_hispanic'
...
out_img = r'C:\Users\liux29\OneDrive - National Institutes of Health\Research\Community_Mine\CoM_GIS_Data\GIS\Data_validation\out_image_hispanic'
out_img_test = r'C:\Users\liux29\OneDrive - National Institutes of Health\Research\Community_Mine\CoM_GIS_Data\GIS\Data_validation\out_image_hispanic_test'
'''
...
for folder in os.listdir(input_img_2):
    ...
    df_Plist = pd.DataFrame(P_list)
    df_Plist.to_csv(r'C:\Users\liux29\OneDrive - National Institutes of Health\Research\Community_Mine\CoM_GIS_Data\GIS\Data_validation\Plist_df.csv')
...
#    data_shp = gpd.read_file(shapefile)
#    base = data_shp.plot(color ='white', edgecolor='black')
#    gdf.plot(ax= base,marker='o', color='red', markersize=5)   
    ...
    shp_name = re.search("blkg_hispanic\\\(.*?)\.shp",shapefile).group(0)
    print (shp_name)
    ...
    for folder in os.listdir(input_img_2):
        for filename in os.listdir(input_img_2 + '\\'+ folder):
            ...
            if (lon,lat) in pnt_cord:
                shutil.copy2(input_img_2  +'\\'+ folder +'\\'+ filename, out_img +'\\'+ shp_name.strip('blkg_hispanic\\').strip('.shp'))
